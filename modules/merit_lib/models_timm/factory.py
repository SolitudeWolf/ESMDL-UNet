...
def create_model(
    ...
    Args:
        ...
        scriptable (bool): set layer config so that model is jit scriptable (not working for all modules yet)
    ...
    """
    # Parameters that aren't supported by all modules or are intended to only override model defaults if set
    # should default to None in command line args/cfg. Remove them if they are present and not set so that
    # non-supporting modules don't break and default args remain in effect.
