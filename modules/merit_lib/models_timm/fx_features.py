...
# NOTE: By default, any modules from timm.modules.layers that we want to treat as leaf modules go here
# BUT modules from timm.modules should use the registration mechanism below
_leaf_modules = {
...
def register_notrace_module(module: Type[nn.Module]):
    """
    Any module not under timm.modules.layers should get this decorator if we don't want to trace through it.
    """
